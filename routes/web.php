...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('units', UnitController::class)->except(['show', 'edit', 'update', 'destroy']);
    Route::resource('sub-units', SubUnitController::class)->except(['show', 'edit', 'update', 'destroy']);
    ...
    Route::get('/search-file', [DetailItemController::class, 'search'])->name('detail_item.search');
});
